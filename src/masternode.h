...
static const int MASTERNODE_MIN_MNB_SECONDS             =   30;
static const int MASTERNODE_MIN_MNP_SECONDS             =   2 * 60;
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 XPChain - checking if valid masternode)
