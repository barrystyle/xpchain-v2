...
// NOTE: Unlike wallet RPC (which use XPChain values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    ...
    result.push_back(Pair("masternode_payments_started", pindexPrev->nHeight + 1 > consensusParams.abposHeight));
